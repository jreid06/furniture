                    ...
                    <div class="upload-image-container">
                        ...
                        <div class="form-group upload-form-group">
                            ...
                            <div class="alert alert-success alert-dismissible alert-success-sku" role="alert">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <strong>SUCCESS: </strong> <span id="alert-sku-success-msg"></span>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                <button type="button" class="btn btn-primary add-sku-button" id="submitImages" name="button" @click="addSkuImages">VALIDATE SKU</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="header">
                                ...
                                <br>
                                <div class="alert alert-danger alert-dismissible alert-total" role="alert">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            ...
                            <div class="input-group col-xs-12">
                                ...
                                <span class="input-group-btn">
                                    <button class="browse btn btn-primary input-lg disabled" type="button" @click="showUploadBox"><i class="glyphicon glyphicon-search"></i> Browse</button>
                              </span>
                            </div>
                        </div>
