        ...
        <div class="input-group">
            <div class="input-group-prepend">
                <div class="input-group-text">
                    <input type="radio" class="rate-radio" aria-label="Radio button for following text input" data-rate-id="{{rates.id}}" data-order-id="{{order.id}}" data-ep-order-id="{{easypost_order.id}}" {% if default_shipping == rates.id %}checked="checked"{% endif %}>
                </div>
            </div>
